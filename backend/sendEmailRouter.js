...
sendEmailRouter.post(
    ...
    expressAsyncHandler( async (req, res) => {
        ...
        const mailOptions = {
            ...
            html: compiledTemplate.render({secretKey, stegoImageID: req.body.stegoImageID, cryptoStegoLink:`https://cryptostego.herokuapp.com/decoding/${req.body.stegoImageID}`, userEmail: req.body.userEmail, userName: req.body.userName})
        };
